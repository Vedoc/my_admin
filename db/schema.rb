...
ActiveRecord::Schema[7.1].define(version: 20_241_210_143_620) do
  ...
  create_table 'accounts', force: :cascade do |t|
    ...
    t.index %w[accountable_type accountable_id], name: 'index_accounts_on_accountable_type_and_accountable_id'
  ...
  create_table 'admin_users_roles', id: false, force: :cascade do |t|
    ...
    t.bigint 'role_id'
    t.index %w[admin_user_id role_id], name: 'index_admin_users_roles_on_admin_user_id_and_role_id'
  ...
  create_table 'car_makes', force: :cascade do |t|
    ...
    t.index %w[name car_category_id], name: 'index_car_makes_on_name_and_car_category_id', unique: true
  end
  ...
  create_table 'car_models', force: :cascade do |t|
    ...
    t.index %w[name car_make_id], name: 'index_car_models_on_name_and_car_make_id', unique: true
  end
  ...
  create_table 'devices', force: :cascade do |t|
    ...
    t.index %w[device_id platform account_id], name: 'index_devices_on_device_id_and_platform_and_account_id',
                                               unique: true
    t.index %w[device_token device_id], name: 'index_devices_on_device_token_and_device_id', unique: true,
  ...
  create_table 'model_years', force: :cascade do |t|
    ...
    t.index %w[year car_model_id], name: 'index_model_years_on_year_and_car_model_id', unique: true
  end
  ...
  create_table 'offers', force: :cascade do |t|
    ...
    t.index %w[service_request_id shop_id], name: 'index_offers_on_service_request_id_and_shop_id', unique: true
  ...
  create_table 'pictures', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[imageable_type imageable_id], name: 'index_pictures_on_imageable'
  end
